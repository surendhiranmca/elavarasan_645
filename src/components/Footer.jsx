        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-10 border-b border-[var(--border-color)] items-center">
          ...
          <div className="md:col-span-6 space-y-3">
            ...
            <p className="text-xs text-[var(--text-muted)] max-w-md leading-relaxed">
              Undergraduate <strong className="text-[var(--text-main)]">B.Com (Computer Applications)</strong> Student at <strong className="text-[var(--text-main)]">Sacred Heart College (Autonomous), Tirupattur</strong> (Thiruvalluvar University). Committed to commerce & technology excellence.
            </p>
          </div>
